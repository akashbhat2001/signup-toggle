$(document).ready(function () {
    ...
    $(".next").click(function () {
      ...
      console.log("0000000000", $(this).parent());
      //Add Class Active
      
      document.getElementById("steps").innerText =
        1 + Number(document.getElementById("steps").innerText);
        document.getElementById("steps-sec").innerText =
        1 + Number(document.getElementById("steps-sec").innerText);
    ...
    $(".previous").click(function () {
      ...
      document.getElementById("steps").innerText =
        ...
        document.getElementById("steps-sec").innerText =
        Number(document.getElementById("steps-sec").innerText) - 1;
